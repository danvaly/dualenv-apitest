        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            <button
              ...
              className="p-1.5 rounded hover:bg-dark-surface transition-colors"
            ...
            {showMenu === 'main' && (
              <div className="absolute right-0 top-full mt-1 w-40 bg-dark-surface border border-dark-border rounded shadow-lg z-20">
                <button
                  onClick={() => {
                    setShowNewForm(true);
                    setShowMenu(null);
                  }}
                  className="w-full text-left px-3 py-1.5 text-xs text-text-primary hover:bg-dark-border/50 flex items-center gap-2"
                >
                  ...
                  <>
                    ...
                    {collections.length > 1 && (
                      <button
                        ...
                        className="w-full text-left px-3 py-1.5 text-xs text-accent-error hover:bg-dark-border/50 flex items-center gap-2"
                      >
                        <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
